...
- [ ] **Indicadores** — série histórica calculada: evolução de PL, VP/cota, receita, distribuições, número de cotas (diluição por emissões), P/VP com cotação
  - já entregue via informe mensal: PL, VP/cota, nº de cotas, valor do ativo, DY mensal (fração→%, com filtro de lixo auto-declarado), cotistas — atual, 12 meses e histórico
  - pendente: cotação de mercado (P/VP), rendimento em R$, e ajuste da média histórica de VP/cota para desdobramentos (split distorce a média)
