...
.venv\Scripts\pyinstaller --onefile --console --clean --noconfirm --name scout --icon assets\scout.ico --add-data "dados\classificacao_etfs.csv;dados" --add-data "dados\taxas_etfs.csv;dados" src\scout\__main__.py
if errorlevel 1 goto :erro
